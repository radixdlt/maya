...
func (m *StateAccountDepositBehaviourRequestBuilder) Post(ctx context.Context, body i950fd50751836b31c29b35851f9bd0af5f3c32c63b41836407b7c026d8db159e.LtsStateAccountDepositBehaviourRequestable, requestConfiguration *StateAccountDepositBehaviourRequestBuilderPostRequestConfiguration)(i950fd50751836b31c29b35851f9bd0af5f3c32c63b41836407b7c026d8db159e.LtsStateAccountDepositBehaviourResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i950fd50751836b31c29b35851f9bd0af5f3c32c63b41836407b7c026d8db159e.CreateLtsStateAccountDepositBehaviourResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i950fd50751836b31c29b35851f9bd0af5f3c32c63b41836407b7c026d8db159e.LtsStateAccountDepositBehaviourResponseable), nil
}
// ToPostRequestInformation returns deposit behaviour of a single account for multiple resource addresses
// returns a *RequestInformation when successful
func (m *StateAccountDepositBehaviourRequestBuilder) ToPostRequestInformation(ctx context.Context, body i950fd50751836b31c29b35851f9bd0af5f3c32c63b41836407b7c026d8db159e.LtsStateAccountDepositBehaviourRequestable, requestConfiguration *StateAccountDepositBehaviourRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
