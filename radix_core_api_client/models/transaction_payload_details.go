...
type TransactionPayloadDetails struct {
...
// NewTransactionPayloadDetails instantiates a new TransactionPayloadDetails and sets the default values.
func NewTransactionPayloadDetails() *TransactionPayloadDetails {
	m := &TransactionPayloadDetails{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateTransactionPayloadDetailsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateTransactionPayloadDetailsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewTransactionPayloadDetails(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *TransactionPayloadDetails) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetErrorMessage gets the error_message property value. An explanation for the error, if failed or rejected
// returns a *string when successful
func (m *TransactionPayloadDetails) GetErrorMessage() *string {
	return m.error_message
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *TransactionPayloadDetails) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["status"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetEnumValue(ParseTransactionPayloadStatus)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetStatus(val.(*TransactionPayloadStatus))
		}
		return nil
	}
	return res
...
// returns a *string when successful
func (m *TransactionPayloadDetails) GetPayloadHash() *string {
...
// returns a *string when successful
func (m *TransactionPayloadDetails) GetPayloadHashBech32m() *string {
	return m.payload_hash_bech32m
}

// GetStateVersion gets the state_version property value. The state_version property
// returns a *int64 when successful
func (m *TransactionPayloadDetails) GetStateVersion() *int64 {
	return m.state_version
}

// GetStatus gets the status property value. The status property
// returns a *TransactionPayloadStatus when successful
func (m *TransactionPayloadDetails) GetStatus() *TransactionPayloadStatus {
	return m.status
}

// Serialize serializes information the current object
func (m *TransactionPayloadDetails) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *TransactionPayloadDetails) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetErrorMessage sets the error_message property value. An explanation for the error, if failed or rejected
func (m *TransactionPayloadDetails) SetErrorMessage(value *string) {
...
func (m *TransactionPayloadDetails) SetPayloadHash(value *string) {
...
func (m *TransactionPayloadDetails) SetPayloadHashBech32m(value *string) {
	m.payload_hash_bech32m = value
}

// SetStateVersion sets the state_version property value. The state_version property
func (m *TransactionPayloadDetails) SetStateVersion(value *int64) {
	m.state_version = value
}

// SetStatus sets the status property value. The status property
func (m *TransactionPayloadDetails) SetStatus(value *TransactionPayloadStatus) {
	m.status = value
}

type TransactionPayloadDetailsable interface {
