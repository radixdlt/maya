...
type TransactionPreviewRequest struct {
	...
	// The flags property
	flags TransactionPreviewRequest_flagsable
...
// GetBlobsHex gets the blobs_hex property value. An array of hex-encoded blob data (optional)
// returns a []string when successful
func (m *TransactionPreviewRequest) GetBlobsHex() []string {
	return m.blobs_hex
}

// GetEndEpochExclusive gets the end_epoch_exclusive property value. An integer between `0` and `10^10`, marking the epoch at which the transaction is no longer valid
...
func (m *TransactionPreviewRequest) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["flags"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTransactionPreviewRequest_flagsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetFlags(val.(TransactionPreviewRequest_flagsable))
		}
		return nil
	}
...
// returns a TransactionPreviewRequest_flagsable when successful
func (m *TransactionPreviewRequest) GetFlags() TransactionPreviewRequest_flagsable {
	return m.flags
}
...
// GetNonce gets the nonce property value. An integer between `0` and `2^32 - 1`, chosen to allow a unique intent to be created (to enable submitting an otherwise identical/duplicate intent).
// returns a *int64 when successful
func (m *TransactionPreviewRequest) GetNonce() *int64 {
	return m.nonce
}

// GetNotaryIsSignatory gets the notary_is_signatory property value. Whether the notary should count as a signatory (optional, default false)
...
// GetSignerPublicKeys gets the signer_public_keys property value. A list of public keys to be used as transaction signers
// returns a []PublicKeyable when successful
func (m *TransactionPreviewRequest) GetSignerPublicKeys() []PublicKeyable {
	return m.signer_public_keys
}

// GetStartEpochInclusive gets the start_epoch_inclusive property value. An integer between `0` and `10^10`, marking the epoch at which the transaction starts being valid
// returns a *int64 when successful
...
// SetBlobsHex sets the blobs_hex property value. An array of hex-encoded blob data (optional)
func (m *TransactionPreviewRequest) SetBlobsHex(value []string) {
	m.blobs_hex = value
}

// SetEndEpochExclusive sets the end_epoch_exclusive property value. An integer between `0` and `10^10`, marking the epoch at which the transaction is no longer valid
...
func (m *TransactionPreviewRequest) SetFlags(value TransactionPreviewRequest_flagsable) {
	m.flags = value
}
...
// SetNonce sets the nonce property value. An integer between `0` and `2^32 - 1`, chosen to allow a unique intent to be created (to enable submitting an otherwise identical/duplicate intent).
func (m *TransactionPreviewRequest) SetNonce(value *int64) {
	m.nonce = value
}

// SetNotaryIsSignatory sets the notary_is_signatory property value. Whether the notary should count as a signatory (optional, default false)
...
// SetSignerPublicKeys sets the signer_public_keys property value. A list of public keys to be used as transaction signers
func (m *TransactionPreviewRequest) SetSignerPublicKeys(value []PublicKeyable) {
	m.signer_public_keys = value
}

// SetStartEpochInclusive sets the start_epoch_inclusive property value. An integer between `0` and `10^10`, marking the epoch at which the transaction starts being valid
...
type TransactionPreviewRequestable interface {
	...
	GetFlags() TransactionPreviewRequest_flagsable
	GetManifest() *string
	...
	SetFlags(value TransactionPreviewRequest_flagsable)
