...
type RecoveryProposal struct {
	...
	// The confirmation_role property
	confirmation_role AccessRuleable
	// The primary_role property
	primary_role AccessRuleable
	// The recovery_role property
...
// GetConfirmationRole gets the confirmation_role property value. The confirmation_role property
...
// GetPrimaryRole gets the primary_role property value. The primary_role property
// returns a AccessRuleable when successful
func (m *RecoveryProposal) GetPrimaryRole() AccessRuleable {
	return m.primary_role
}

// GetRecoveryRole gets the recovery_role property value. The recovery_role property
// returns a AccessRuleable when successful
...
// SetConfirmationRole sets the confirmation_role property value. The confirmation_role property
func (m *RecoveryProposal) SetConfirmationRole(value AccessRuleable) {
	m.confirmation_role = value
}

// SetPrimaryRole sets the primary_role property value. The primary_role property
func (m *RecoveryProposal) SetPrimaryRole(value AccessRuleable) {
	m.primary_role = value
}

// SetRecoveryRole sets the recovery_role property value. The recovery_role property
