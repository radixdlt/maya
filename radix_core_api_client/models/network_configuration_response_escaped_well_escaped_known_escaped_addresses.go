...
type NetworkConfigurationResponse_well_known_addresses struct {
    ...
    // The test_utils_package property
    ...
    // The transaction_tracker_package property
...
func (m *NetworkConfigurationResponse_well_known_addresses) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["test_utils_package"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTestUtilsPackage(val)
        }
        return nil
    }
    ...
    res["transaction_tracker_package"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetStringValue()
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTransactionTrackerPackage(val)
        }
        return nil
    }
...
// GetTestUtilsPackage gets the test_utils_package property value. The test_utils_package property
// returns a *string when successful
func (m *NetworkConfigurationResponse_well_known_addresses) GetTestUtilsPackage()(*string) {
    return m.test_utils_package
}
...
// GetTransactionTrackerPackage gets the transaction_tracker_package property value. The transaction_tracker_package property
// returns a *string when successful
func (m *NetworkConfigurationResponse_well_known_addresses) GetTransactionTrackerPackage()(*string) {
    return m.transaction_tracker_package
}
...
func (m *NetworkConfigurationResponse_well_known_addresses) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteStringValue("test_utils_package", m.GetTestUtilsPackage())
        if err != nil {
            return err
        }
    }
    ...
    {
        err := writer.WriteStringValue("transaction_tracker_package", m.GetTransactionTrackerPackage())
        if err != nil {
            return err
        }
    }
...
// SetTestUtilsPackage sets the test_utils_package property value. The test_utils_package property
func (m *NetworkConfigurationResponse_well_known_addresses) SetTestUtilsPackage(value *string)() {
    m.test_utils_package = value
}
...
// SetTransactionTrackerPackage sets the transaction_tracker_package property value. The transaction_tracker_package property
func (m *NetworkConfigurationResponse_well_known_addresses) SetTransactionTrackerPackage(value *string)() {
    m.transaction_tracker_package = value
}
