...
// GetOutput gets the output property value. The manifest line-by-line engine return data (only present if `status` is `Succeeded`)
...
// SetOutput sets the output property value. The manifest line-by-line engine return data (only present if `status` is `Succeeded`)
