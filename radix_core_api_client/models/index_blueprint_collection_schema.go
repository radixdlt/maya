...
type IndexBlueprintCollectionSchema struct {
...
// NewIndexBlueprintCollectionSchema instantiates a new IndexBlueprintCollectionSchema and sets the default values.
func NewIndexBlueprintCollectionSchema()(*IndexBlueprintCollectionSchema) {
    m := &IndexBlueprintCollectionSchema{
        BlueprintCollectionSchema: *NewBlueprintCollectionSchema(),
    }
    return m
}
// CreateIndexBlueprintCollectionSchemaFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateIndexBlueprintCollectionSchemaFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewIndexBlueprintCollectionSchema(), nil
}
// GetAllowOwnership gets the allow_ownership property value. Whether the entries of the index partition are allowed to own child nodes.
// returns a *bool when successful
func (m *IndexBlueprintCollectionSchema) GetAllowOwnership()(*bool) {
    return m.allow_ownership
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *IndexBlueprintCollectionSchema) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *IndexBlueprintCollectionSchema) GetKeyTypeRef()(BlueprintPayloadDefable) {
    return m.key_type_ref
}
// GetValueTypeRef gets the value_type_ref property value. The value_type_ref property
// returns a BlueprintPayloadDefable when successful
func (m *IndexBlueprintCollectionSchema) GetValueTypeRef()(BlueprintPayloadDefable) {
    return m.value_type_ref
}
// Serialize serializes information the current object
func (m *IndexBlueprintCollectionSchema) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
// SetAllowOwnership sets the allow_ownership property value. Whether the entries of the index partition are allowed to own child nodes.
func (m *IndexBlueprintCollectionSchema) SetAllowOwnership(value *bool)() {
    m.allow_ownership = value
}
// SetKeyTypeRef sets the key_type_ref property value. The key_type_ref property
func (m *IndexBlueprintCollectionSchema) SetKeyTypeRef(value BlueprintPayloadDefable)() {
    m.key_type_ref = value
}
// SetValueTypeRef sets the value_type_ref property value. The value_type_ref property
func (m *IndexBlueprintCollectionSchema) SetValueTypeRef(value BlueprintPayloadDefable)() {
    m.value_type_ref = value
}
type IndexBlueprintCollectionSchemaable interface {
