...
// GetHashBech32m gets the hash_bech32m property value. The Bech32m-encoded human readable `SignedIntentHash`.
// returns a *string when successful
...
// SetHashBech32m sets the hash_bech32m property value. The Bech32m-encoded human readable `SignedIntentHash`.
