...
// GetEncodedReceipt gets the encoded_receipt property value. The hex-sbor-encoded receipt
...
// SetEncodedReceipt sets the encoded_receipt property value. The hex-sbor-encoded receipt
