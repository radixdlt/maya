...
func (m *LtsTransactionSubmitPriorityThresholdNotMetErrorDetails) GetMinTipProportionRequired()(*string) {
...
// returns a *string when successful
func (m *LtsTransactionSubmitPriorityThresholdNotMetErrorDetails) GetTipProportion()(*string) {
...
func (m *LtsTransactionSubmitPriorityThresholdNotMetErrorDetails) SetMinTipProportionRequired(value *string)() {
...
func (m *LtsTransactionSubmitPriorityThresholdNotMetErrorDetails) SetTipProportion(value *string)() {
