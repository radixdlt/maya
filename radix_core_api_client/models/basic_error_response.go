...
// NewBasicErrorResponse instantiates a new BasicErrorResponse and sets the default values.
func NewBasicErrorResponse()(*BasicErrorResponse) {
    m := &BasicErrorResponse{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateBasicErrorResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateBasicErrorResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewBasicErrorResponse(), nil
}
// Error the primary error message.
// returns a string when successful
func (m *BasicErrorResponse) Error()(string) {
    return m.ApiError.Error()
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *BasicErrorResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCode gets the code property value. A numeric code corresponding to the given HTTP error code.
// returns a *int32 when successful
func (m *BasicErrorResponse) GetCode()(*int32) {
    return m.code
}
// GetErrorType gets the error_type property value. The error_type property
// returns a *ErrorResponseType when successful
func (m *BasicErrorResponse) GetErrorType()(*ErrorResponseType) {
    return m.error_type
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *BasicErrorResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *BasicErrorResponse) GetMessage()(*string) {
    return m.message
}
...
// returns a *string when successful
func (m *BasicErrorResponse) GetTraceId()(*string) {
    return m.trace_id
}
// Serialize serializes information the current object
func (m *BasicErrorResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *BasicErrorResponse) SetTraceId(value *string)() {
    m.trace_id = value
}
type BasicErrorResponseable interface {
