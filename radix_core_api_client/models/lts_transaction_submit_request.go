...
type LtsTransactionSubmitRequest struct {
...
// NewLtsTransactionSubmitRequest instantiates a new LtsTransactionSubmitRequest and sets the default values.
func NewLtsTransactionSubmitRequest()(*LtsTransactionSubmitRequest) {
    m := &LtsTransactionSubmitRequest{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateLtsTransactionSubmitRequestFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateLtsTransactionSubmitRequestFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewLtsTransactionSubmitRequest(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *LtsTransactionSubmitRequest) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *LtsTransactionSubmitRequest) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *LtsTransactionSubmitRequest) GetForceRecalculate()(*bool) {
    return m.force_recalculate
}
// GetNetwork gets the network property value. The logical name of the network
// returns a *string when successful
func (m *LtsTransactionSubmitRequest) GetNetwork()(*string) {
    return m.network
}
...
// returns a *string when successful
func (m *LtsTransactionSubmitRequest) GetNotarizedTransactionHex()(*string) {
    return m.notarized_transaction_hex
}
// Serialize serializes information the current object
func (m *LtsTransactionSubmitRequest) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *LtsTransactionSubmitRequest) SetAdditionalData(value map[string]any)() {
...
func (m *LtsTransactionSubmitRequest) SetForceRecalculate(value *bool)() {
    m.force_recalculate = value
}
// SetNetwork sets the network property value. The logical name of the network
func (m *LtsTransactionSubmitRequest) SetNetwork(value *string)() {
    m.network = value
}
...
func (m *LtsTransactionSubmitRequest) SetNotarizedTransactionHex(value *string)() {
    m.notarized_transaction_hex = value
}
type LtsTransactionSubmitRequestable interface {
