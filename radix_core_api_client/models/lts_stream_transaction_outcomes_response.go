...
type LtsStreamTransactionOutcomesResponse struct {
...
// NewLtsStreamTransactionOutcomesResponse instantiates a new LtsStreamTransactionOutcomesResponse and sets the default values.
func NewLtsStreamTransactionOutcomesResponse()(*LtsStreamTransactionOutcomesResponse) {
    m := &LtsStreamTransactionOutcomesResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateLtsStreamTransactionOutcomesResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateLtsStreamTransactionOutcomesResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewLtsStreamTransactionOutcomesResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *LtsStreamTransactionOutcomesResponse) GetAdditionalData()(map[string]any) {
...
func (m *LtsStreamTransactionOutcomesResponse) GetCommittedTransactionOutcomes()([]LtsCommittedTransactionOutcomeable) {
...
func (m *LtsStreamTransactionOutcomesResponse) GetCount()(*int32) {
    return m.count
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *LtsStreamTransactionOutcomesResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *LtsStreamTransactionOutcomesResponse) GetFromStateVersion()(*int64) {
...
// returns a *int64 when successful
func (m *LtsStreamTransactionOutcomesResponse) GetMaxLedgerStateVersion()(*int64) {
    return m.max_ledger_state_version
}
// Serialize serializes information the current object
func (m *LtsStreamTransactionOutcomesResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *LtsStreamTransactionOutcomesResponse) SetAdditionalData(value map[string]any)() {
...
func (m *LtsStreamTransactionOutcomesResponse) SetCommittedTransactionOutcomes(value []LtsCommittedTransactionOutcomeable)() {
...
func (m *LtsStreamTransactionOutcomesResponse) SetCount(value *int32)() {
    m.count = value
}
// SetFromStateVersion sets the from_state_version property value. The from_state_version property
func (m *LtsStreamTransactionOutcomesResponse) SetFromStateVersion(value *int64)() {
...
func (m *LtsStreamTransactionOutcomesResponse) SetMaxLedgerStateVersion(value *int64)() {
    m.max_ledger_state_version = value
}
type LtsStreamTransactionOutcomesResponseable interface {
