...
func (i SubstateType) String() string {
	return []string{"BootLoaderModuleFieldSystemBoot", "BootLoaderModuleFieldVmBoot", "BootLoaderModuleFieldKernelBoot", "TypeInfoModuleFieldTypeInfo", "RoleAssignmentModuleFieldOwnerRole", "RoleAssignmentModuleRuleEntry", "RoleAssignmentModuleMutabilityEntry", "RoyaltyModuleFieldState", "RoyaltyModuleMethodRoyaltyEntry", "MetadataModuleEntry", "PackageFieldRoyaltyAccumulator", "PackageCodeVmTypeEntry", "PackageCodeOriginalCodeEntry", "PackageCodeInstrumentedCodeEntry", "SchemaEntry", "PackageBlueprintDefinitionEntry", "PackageBlueprintDependenciesEntry", "PackageBlueprintRoyaltyEntry", "PackageBlueprintAuthTemplateEntry", "PackageFieldFunctionAccessRules", "FungibleResourceManagerFieldDivisibility", "FungibleResourceManagerFieldTotalSupply", "NonFungibleResourceManagerFieldIdType", "NonFungibleResourceManagerFieldTotalSupply", "NonFungibleResourceManagerFieldMutableFields", "NonFungibleResourceManagerDataEntry", "FungibleVaultFieldBalance", "FungibleVaultFieldFrozenStatus", "NonFungibleVaultFieldBalance", "NonFungibleVaultFieldFrozenStatus", "NonFungibleVaultContentsIndexEntry", "ConsensusManagerFieldConfig", "ConsensusManagerFieldState", "ConsensusManagerFieldCurrentValidatorSet", "ConsensusManagerFieldCurrentProposalStatistic", "ConsensusManagerFieldCurrentTimeRoundedToMinutes", "ConsensusManagerFieldCurrentTime", "ConsensusManagerFieldValidatorRewards", "ConsensusManagerRegisteredValidatorsByStakeIndexEntry", "ValidatorFieldState", "ValidatorFieldProtocolUpdateReadinessSignal", "AccountFieldState", "AccountVaultEntry", "AccountResourcePreferenceEntry", "AccountAuthorizedDepositorEntry", "AccountLockerAccountClaimsEntry", "AccessControllerFieldState", "GenericScryptoComponentFieldState", "GenericKeyValueStoreEntry", "OneResourcePoolFieldState", "TwoResourcePoolFieldState", "MultiResourcePoolFieldState", "TransactionTrackerFieldState", "TransactionTrackerCollectionEntry"}[i]
}
...
func ParseSubstateType(v string) (any, error) {
	...
	default:
		return 0, errors.New("Unknown SubstateType value: " + v)
	}
	return &result, nil
}
