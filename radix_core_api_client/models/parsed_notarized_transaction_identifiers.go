...
type ParsedNotarizedTransactionIdentifiers struct {
...
// NewParsedNotarizedTransactionIdentifiers instantiates a new ParsedNotarizedTransactionIdentifiers and sets the default values.
func NewParsedNotarizedTransactionIdentifiers() *ParsedNotarizedTransactionIdentifiers {
	m := &ParsedNotarizedTransactionIdentifiers{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateParsedNotarizedTransactionIdentifiersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateParsedNotarizedTransactionIdentifiersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewParsedNotarizedTransactionIdentifiers(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *ParsedNotarizedTransactionIdentifiers) GetIntentHash() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetIntentHashBech32m() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetLedgerHash() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetLedgerHashBech32m() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetPayloadHash() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetPayloadHashBech32m() *string {
...
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetSignedIntentHash() *string {
	return m.signed_intent_hash
}

// GetSignedIntentHashBech32m gets the signed_intent_hash_bech32m property value. The Bech32m-encoded human readable `SignedIntentHash`.
// returns a *string when successful
func (m *ParsedNotarizedTransactionIdentifiers) GetSignedIntentHashBech32m() *string {
	return m.signed_intent_hash_bech32m
}

// Serialize serializes information the current object
func (m *ParsedNotarizedTransactionIdentifiers) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ParsedNotarizedTransactionIdentifiers) SetAdditionalData(value map[string]any) {
...
func (m *ParsedNotarizedTransactionIdentifiers) SetIntentHash(value *string) {
	m.intent_hash = value
}

// SetIntentHashBech32m sets the intent_hash_bech32m property value. The Bech32m-encoded human readable `IntentHash`.
func (m *ParsedNotarizedTransactionIdentifiers) SetIntentHashBech32m(value *string) {
...
func (m *ParsedNotarizedTransactionIdentifiers) SetLedgerHash(value *string) {
	m.ledger_hash = value
}

// SetLedgerHashBech32m sets the ledger_hash_bech32m property value. The Bech32m-encoded human readable `LedgerPayloadHash`.
func (m *ParsedNotarizedTransactionIdentifiers) SetLedgerHashBech32m(value *string) {
...
func (m *ParsedNotarizedTransactionIdentifiers) SetPayloadHash(value *string) {
...
func (m *ParsedNotarizedTransactionIdentifiers) SetPayloadHashBech32m(value *string) {
...
func (m *ParsedNotarizedTransactionIdentifiers) SetSignedIntentHash(value *string) {
	m.signed_intent_hash = value
}

// SetSignedIntentHashBech32m sets the signed_intent_hash_bech32m property value. The Bech32m-encoded human readable `SignedIntentHash`.
func (m *ParsedNotarizedTransactionIdentifiers) SetSignedIntentHashBech32m(value *string) {
	m.signed_intent_hash_bech32m = value
}

type ParsedNotarizedTransactionIdentifiersable interface {
